export const projects = [
    {
        title: "Pig Game",
        subtitle: "MERN Stack",
        description: "This game is played using a Dice where the user is supposed to roll the dice to get the desired number.",
...
export const skills = ["React", "Java", "Spring Boot", "JavaScript", "C#", ".NET", "ASP .NET", "MySQL", "MongoDB", "Node"];
